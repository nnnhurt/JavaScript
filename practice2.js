//создайте функцию mergeObjects(obj1, obj2), которая объединяет два объекта и возвращает новый объект.
//Создайте класс Robot, который имеет метод performTask. Наследуйте классы CleaningRobot, GuardRobot и AssistantRobot, каждый из которрых
// выполнает свою задачу (уборка, охрана, помощь людям) и исп уникальный набор датчиков
